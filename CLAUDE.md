...
|---|---|---|
| **Bot** | 2.6.14 | `package.json` |
| **Agent** (`wolfpack-logsync`) | 2.5.20 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 0.5.21 | `web/package.json` |
| **Mimic** (Electron desktop, BETA) | 0.1.0-mimic-beta.17 | `apps/mimic/package.json` |
