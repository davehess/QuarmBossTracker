...
| **Agent** (`wolfpack-logsync`) | 3.0.2 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 1.0.1 | `web/package.json` |
| **Mimic** (Electron desktop) | 1.0.4 | `apps/mimic/package.json` |
