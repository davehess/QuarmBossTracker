...
|---|---|---|
| **Bot** | 2.6.2 | `package.json` |
| **Agent** (`wolfpack-logsync`) | 2.5.2 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 0.5.14 | `web/package.json` |
| **Mimic** (Electron desktop, BETA) | 0.1.0-beta.11 | `apps/mimic/package.json` |
