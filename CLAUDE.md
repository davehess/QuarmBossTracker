...
|---|---|---|
| **Bot** | 3.0.11 | `package.json` |
| **Agent** (`wolfpack-logsync`) | 3.0.13 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 1.0.18 | `web/package.json` |
| **Mimic** (Electron desktop) | 1.0.15 | `apps/mimic/package.json` |
