...
|---|---|---|
| **Bot** | 2.7.14 | `package.json` |
| **Agent** (`wolfpack-logsync`) | 2.5.76 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 0.5.50 | `web/package.json` |
| **Mimic** (Electron desktop, PREVIEW) | 1.0.0-mimic-beta.60 | `apps/mimic/package.json` |
