...
| **Agent** (`wolfpack-logsync`) | 3.0.68 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 1.0.38 | `web/package.json` |
| **Mimic** (Electron desktop) | 1.0.62 (stable, main) / 1.0.62-beta.1 (beta channel) | `apps/mimic/package.json` |
