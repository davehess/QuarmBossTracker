...
| **Agent** (`wolfpack-logsync`) | 2.5.7 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 0.5.18 | `web/package.json` |
| **Mimic** (Electron desktop, BETA) | 0.1.0-beta.12 | `apps/mimic/package.json` |
