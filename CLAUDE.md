...
| **Agent** (`wolfpack-logsync`) | 3.0.90 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 1.0.45 | `web/package.json` |
| **Mimic** (Electron desktop) | 1.0.66 (stable, main) / 1.0.67-beta.12 (beta channel) | `apps/mimic/package.json` |
