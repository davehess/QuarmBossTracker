...
| **Agent** (`wolfpack-logsync`) | 2.5.75 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 0.5.49 | `web/package.json` |
| **Mimic** (Electron desktop, PREVIEW) | 1.0.0-mimic-beta.59 | `apps/mimic/package.json` |
