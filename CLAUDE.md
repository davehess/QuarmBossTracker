...
| **Agent** (`wolfpack-logsync`) | 3.0.73 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 1.0.39 | `web/package.json` |
| **Mimic** (Electron desktop) | 1.0.65 (stable, main) / 1.0.66-beta.3 (beta channel) | `apps/mimic/package.json` |
