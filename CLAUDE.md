...
| **Agent** (`wolfpack-logsync`) | 3.0.1 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 1.0.0 | `web/package.json` |
| **Mimic** (Electron desktop) | 1.0.3 | `apps/mimic/package.json` |
