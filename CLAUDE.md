...
| **Agent** (`wolfpack-logsync`) | 3.0.23 | `packages/wolfpack-logsync/package.json` |
| **Web** (`wolfpack.quest`) | 1.0.27 | `web/package.json` |
| **Mimic** (Electron desktop) | 1.0.22 | `apps/mimic/package.json` |
