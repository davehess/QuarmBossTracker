...
app.whenReady().then(async () => {
  ...
  // #156 — Zeal auto-updater: notify-only check ~25s after boot (let the EQ
  // folder + agent settle), then every 12h. Install stays a one-click user
  // action; this only nudges when CoastalRedwood ships a newer Zeal.
