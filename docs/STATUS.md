...
| `mimic-steamdeck.md` / `mimic-steamdeck-zeal-bridge.md` | [#156] What Mimic does on Linux (status table, Background Mode, build/channel) + the Phase-2 Zeal pipe-bridge design (`outflow`, the wineserver constraint that rules out Bottles) | Phase 1 field-verified 2026-08-23 (2.6.1-linux.19 launches + renders); Phase 2 bridge in progress. **Procedure lives in `RUNBOOK-deck-install.md`, not these** |
