...
- **⏳ Quests and inventory get separate sharing switches (on `beta`, 2026-09-25).** The guild lead: *"we should separate out inventory versus quests."* "Quest page" and "Inventory page" switches on `/me`; a shared quest page hides inventory listings when the inventory page is private. Column live and backfilled; graduation waits on the guild lead's preview and the call on the 11 characters that had the old switch on. `DECISIONS-2026-09-21.md` §24.
