...
- **⏳ Zeal: six icon tag shapes (branch `tag-shapes` on the guild lead's fork, not built yet, 2026-09-25).** `^1^`–`^6^` = skull, X, sword, diamond, flame, star, built from convex parts with proud accent details; previewed off-client from the real geometry code. `docs/upstream/zeal-tag-shapes/`, `DECISIONS-2026-09-21.md` §27.
