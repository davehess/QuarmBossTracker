...
- **⏳ Mimic: the /who overlay puts the player you target on top, guild under the name (agent 3.7.19 on beta, 2026-09-26).** For raids shared with other guilds: click a player and a Target card shows their name, class, level and, on the line under, their guild (from this /who, else /who history in italics; works before any /who). Pets never get a card. Waiting on a beta check in a raid. `docs/HOW-ITS-BUILT.md` (Mimic features), `DECISIONS-2026-09-21.md` §41.
