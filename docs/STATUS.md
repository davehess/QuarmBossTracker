...
- **⏳ Deathrolls tracked (bot 3.1.142 + migration `20260924050246`, 2026-09-23).** The guild lead: *"First one to roll a zero loses - we should track these for fun"*, posted to #wlfpck-general. Recording + the post are live from the bot alone (every Mimic already uploads rolls). Still to land: the one-line Rolls-card display (option A, agent on `beta`) and the /fun card (`b.wolfpack.quest/fun` first). `DECISIONS-2026-09-21.md` §10.
