...
// (the guild lead, 2026-06-24: "Build the script import".)
//
// Patterns recognized:
//
...
// content-stable so dedup works across runs. (the guild lead, 2026-06-24.)
...
//       Toes). The importer missed these entirely until now. (the guild lead
//       2026-06-24.)
...
function parseLuaTurnIns(src) {
  ...
  while ((m = checkRx.exec(src)) !== null) {
    ...
    // flavor handins. Mirrors the Perl filter. (the guild lead, 2026-06-24.)
...
// but whose body still contains handin calls. (the guild lead, 2026-06-24: Foreman
...
async function upsertBatch(rows, { commit }) {
  ...
  // text. (the guild lead, 2026-06-24.)
