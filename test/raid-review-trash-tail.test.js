...
//
// The guild lead reported it as "we're also getting a bunch of the trash from earlier
...
describe('trashBoundsFor', () => {
  ...
  it('defaults to a 15-minute grace', () => {
    ...
    // change what ships and break nothing. 15 is the guild lead's call: the line is
