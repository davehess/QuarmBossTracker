...
//
// First cut of this feature invented a social grammar ("tag %T 87") — a member
...
describe('noteTagChannelLine — the real wire format', () => {
  ...
  // ── The transports the first cut missed. The guild lead's first live test (two
...
// ── Append semantics (the guild lead, 2026-08-06) ──────────────────────────────────
