    ...
    <div className="space-y-6">
      ...
      <section className="bg-panel border border-border rounded-lg p-6">
        ...
        <p className="text-sm text-dim leading-6">
          ...
          (Mimic 2.6.0+ picks the file up automatically within ~10 minutes). Hover an item for stats. Click through to PQDI for the full sheet.
        </p>
        ...
        {inv.length === 0 && (
          <p className="text-xs text-orange mt-3">
            ⚠ No inventory snapshot yet for {decoded}. Run <code>/outputfile inventory</code> in EQ with Mimic running — Mimic 2.6.0+ picks the file up within ~10 minutes. Or upload manually via 🎒 on <Link href="/me" className="text-blue hover:underline">/me</Link>.
          </p>
        )}
      </section>
