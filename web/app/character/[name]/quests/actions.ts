...
// (the guild lead, 2026-06-23: "users should be able to reorder/hide/dismiss quests
...
//                   quests to the active quests section", the guild lead 2026-06-24)
//   • 'dismissed' → hidden from discovery ("mark off which quests are not of
//                   interest, and remove them from the list", the guild lead 2026-06-24)
