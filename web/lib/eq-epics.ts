...
// see it at a glance.  (the guild lead, 2026-06-26: "for example the dragon scales
// of kedge backbone".)
//
...
export const EPIC_COMPONENTS: Record<string, EpicComponent[]> = {
  ...
  'Druid': [
    ...
    // (16889) were removed 2026-06-30 (The guild lead: "journeyman's boots are not
  ...
  'Shaman': [
    ...
    // grind that comes before the Tear. (the guild lead, 2026-06-26: P99/quarm.guide
    // hints + DB verify.)
  ...
  'Monk': [
    // 2026-06-30 (The guild lead: real epic components were missing / mis-depthed).
  ...
  // hasn't captured these turn-ins as scripted yet. (the guild lead, 2026-06-26.)
  'Shadow Knight': [
